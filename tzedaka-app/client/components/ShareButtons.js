...
const LinkedinButton = () => {
	return (
		<a className={buttonStyle} target="_blank" rel="noopener" href={`https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Ftzedaka-neon.vercel.app%2F&title=test&summary=test&source=https%3A%2F%2Ftzedaka-neon.vercel.app%2F`} aria-label="Share on Linkedin" draggable="false">
			<svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
...
const WhatsappButton = () => {
	return (
		<a className={buttonStyle} target="_blank" rel="noopener" href={`https://wa.me/?text=${encodeURIComponent(`${shareText} https://tzedaka-neon.vercel.app/`)}`} aria-label="Share on Whatsapp" draggable="false">
			<svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
...
const EmailButton = () => {
	return (
		<a className={buttonStyle} target="_blank" rel="noopener" href={`mailto:?subject=test&body=${encodeURIComponent(`${shareText} https://tzedaka-neon.vercel.app/`)}`} aria-label="Share by Email" draggable="false">
			<svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-6 h-6">
				<title>Email</title>
