    ...
    return (
      <div className="text-white text-center md:w-2/6 md:h-1/3 md:mr-20">
        ...
        <p className={`m-6 text-xl ${universe45Light.className}`}>
          ...
          cambiar una vida. En esencia, eso es lo que hace un Padrino o una Madrina:
          darle a un chico o a un joven una oportunidad, acompañarlo en su
          educación y sostenerlo dentro de un proyecto que le abre puertas de un futuro distinto.
          Los programas educativos de la Fundación Tzedaká brindan apoyo a estudiantes en situación 
          de vulnerabilidad para que puedan completar sus estudios y formar un proyecto de vida.
          ¡Sumate! Tu ayuda hace la diferencia.
        </p>
      </div>
    );
  };
