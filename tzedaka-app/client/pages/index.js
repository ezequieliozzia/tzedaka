...
const Index = () => {
  return (
    <>
      <div className="relative h-84vh mx-6 rounded-md">
        ...
        <div className="absolute inset-0 flex md:items-start md:my-20 md:justify-center md:justify-end">
          <div className="flex flex-col items-center md:items-center md:justify-center md:w-2/6 md:h-1/3 bg-transparent md:mr-20 rounded-md">
            <p
